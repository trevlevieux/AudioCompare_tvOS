//
//  Tracks_MainViewController.swift
//  AudioCompare_tvOS
//
...
class Tracks_MainViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    @IBAction func nextButtonPressed() {
        self.performSegue(withIdentifier: "segue_selectTrack", sender: nil)
    }
